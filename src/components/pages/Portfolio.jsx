export default function Portfolio() {
	...
	<div className="card" style={{ width: '18rem' }}>
      ...
      <div className="card" style={{ width: '18rem' }}>
		...
		<div className="card" style={{ width: '18rem' }}>
		<img src="/images/Index.html-ss.png" className="card-img-top" alt="Server Side API Project" />
		<div className="card-body">
		...
		<div className="card" style={{ width: '18rem' }}>
		<img src="/images/Weather-Dashboard.png" className="card-img-top" alt="Weather Forecast" />
		<div className="card-body">
		...
		<div className="card" style={{ width: '18rem' }}>
		<img src="/images/Text-Editor.png" className="card-img-top" alt="PWA Text Editor" />
		<div className="card-body">
		...
		<div className="card" style={{ width: '18rem' }}>
		<img src="/images/Schedule ss.png" className="card-img-top" alt="Work Day Scheduler" />
		<div className="card-body">
